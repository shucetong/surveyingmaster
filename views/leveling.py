...
def create_leveling_adjustment_view(page: ft.Page, on_back, save_callback, initial_data=None, records_db=None):
    ...
    def open_import_dialog(e):
        ...
        dd = ft.Dropdown(options=options, expand=True, height=48, disabled=not lv_records, content_padding=12, dense=True, border_radius=8, border=ft.InputBorder.OUTLINE,
...
def create_trigonometric_leveling_adjustment_view(page: ft.Page, on_back, save_callback, initial_data=None, records_db=None):
    ...
    def open_import_dialog(e):
        ...
        dd = ft.Dropdown(options=options, expand=True, height=48, disabled=not va_records, content_padding=12, dense=True, border_radius=8, border=ft.InputBorder.OUTLINE,
